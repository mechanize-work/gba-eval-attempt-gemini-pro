        ...
        for i in 0..60 {
            for _ in 0..280896 {
                ...
                if count < 50 {
                    ...
                    println!("Trace: PC={:08X} T={} Z={} R0={:08X} R1={:08X} R2={:08X} R3={:08X} SP={:08X} LR={:08X} instr={:04X}", pc - 2, t, gba_mut().cpu.get_z(), r0, r1, r2, r3, gba_mut().cpu.regs[13], gba_mut().cpu.regs[14], gba_mut().cpu.pipeline[0]);
                    count += 1;
                }
